...
General = {
    ...
    initExtraFunctions: function() {
        ...
        $(document.body).on('click', '#languagePicker li', function() {
    ...
    uploadComplete: function(evt) {
        ...
        setTimeout(function() {
            ...
            if(shareOption === 'link') {
                ...
                $('#copyButton').html('<button class="btn-yonzi copy-button" id="copy-button" data-clipboard-text="'  + siteUrl + Uploader.uploadID + '">'+Lang.i.copy_url+'</button>');
