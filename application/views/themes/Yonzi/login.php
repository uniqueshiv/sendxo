    ...
    <div id="Transfer" class="tabcontent">
        <div class="col-md-6" style="margin-bottom: 20px;">
            <div class="col-md-12 mainform">
                ...
                echo '<div id="custom_account_body" class="settingsBodyContent" style="display: none; overflow: auto;">';
                require_once APPPATH . 'plugins/droppy_premium/views/tabs/account.php';
                echo '</div>';
                                            ...
                                            <div id="settings">
                                                <div class="settingsBody">
                                                    <div id="upload_settings_tab_body" class="settingsBodyContent">
                                                        <p>
                                                            <h3><?php echo lang('share_type'); ?>: <i class="fa fa-question-circle" data-toggle="tooltip" title="<?php echo lang('share_type_text'); ?>"></i></h3>
                                                        </p>
                                                        <div class="btn-group" data-toggle="buttons">
                                                            <label class="btn btn-default btn-sm <?php if ($settings['default_sharetype'] == 'mail') {
                                                                                                        echo 'active';
                                                                                                    } ?>">
                                                                <input type="radio" name="options" id="option1" onchange="Form.pickShareOption('email')" <?php if ($settings['default_sharetype'] == 'mail') {
                                                                                                                                                                echo 'checked=""';
                                                                                                                                                            } ?>> <?php echo lang('email') ?>
                                                            </label>
                                                            <label class="btn btn-default btn-sm <?php if ($settings['default_sharetype'] == 'link') {
                                                                                                        echo 'active';
                                                                                                    } ?>">
                                                                <input type="radio" name="options" id="option2" onchange="Form.pickShareOption('link')" <?php if ($settings['default_sharetype'] == 'link') {
                                                                                                                                                            echo 'checked=""';
                                                                                                                                                        } ?>> <?php echo lang('link') ?>
                                                            </label>
                                                        ...
                                                        <p>
                                                            <h3><?php echo lang('destruct_file'); ?>: <i class="fa fa-question-circle" data-toggle="tooltip" title="<?php echo lang('destruct_text') ?>"></i></h3>
                                                        </p>
                                                        <div class="btn-group" data-toggle="buttons">
                                                        ...
                                                        ?>
                                                            <p>
                                                                <h3><?php echo lang('protect_with_pass'); ?>: <i class="fa fa-question-circle" data-toggle="tooltip" title="<?php echo lang('password_text'); ?>"></i></h3>
                                                            </p>
    ...
    <div id="uploadSuccess" class="progresssuccess" style="display: none; padding-top: 40px;">
        ...
        <div class="buttonSection" style="bottom: -55px;">
            ...
            <div id="okButton" style="display: none;">
                <a href="<?php echo $settings['site_url']; ?>/login" class="btn-yonzi"><?php echo lang('ok'); ?></a>
            </div>
        </div>
    </div>
</div>
...
<div class="col-md-12 mainform">
    ...
    echo '<div id="custom_uploads_body" class="settingsBodyContent" style="display: none; overflow: auto;">';
    require_once APPPATH . 'plugins/droppy_premium/views/tabs/uploads.php';
    echo '</div>';
