<div class="form-panel" style="overflow:hidden;">
    <h4 class="mb"><i class="fa fa-angle-right"></i> Add user & subscription</h4>
    <form class="form-horizontal style-form" method="post" action="<?php echo $this->config->item('site_url') ?>page/premium">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" name="fullname" placeholder="First name of the user" required="required">
            </div>
        </div>
		<div class="form-group">
            <label class="col-sm-2 col-sm-2 control-label">Last name</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" name="lastname" placeholder="Last name of the user" required="required">
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-2 col-sm-2 control-label">Mailing address</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" name="mailingaddress" placeholder="Mailing address of the user">
            </div>
        </div>
		 <div class="form-group">
        ...
        <div class="form-group">
            <label class="col-sm-2 col-sm-2 control-label">Subscription expiry</label>
            <div class="col-sm-10">
                <input type="date" class="form-control" name="expiry" placeholder="The expiry date of the subscription" required="required">
                <i>You should enter it like <strong>24/09/2021</strong> (will be 24 dec. 2021).</i>
            </div>
        </div>
